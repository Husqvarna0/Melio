...
***************************************************************************** */
        ...
        document.addEventListener("click", (function(event) {
            if (window.innerWidth > 767.98) if (!event.target.closest(".menu__body")) {
                document.documentElement.classList.remove("menu-open");
                document.documentElement.classList.remove("lock");
            }
        }));
        window.addEventListener("resize", (function() {
            if (window.innerWidth <= 767.98) document.querySelector(".bottom-header__input").placeholder = "Знайти"; else document.querySelector(".bottom-header__input").placeholder = "Знайти товар";
        }));
        if (window.innerWidth <= 767.98 && document.getElementById("newsLink")) {
            let newsLink = document.getElementById("newsLink");
            newsLink.innerHTML = "Переглянути все";
        }
        window.addEventListener("resize", (function() {
            var newsLink = document.getElementById("newsLink");
            if (newsLink) if (window.innerWidth <= 767.98 && newsLink.innerHTML) newsLink.innerHTML = "Переглянути все"; else if (newsLink.innerHTML) newsLink.innerHTML = "Переглянути все";
        }));
        ...
        if (window.innerWidth <= 479.98 && blogText1 && blogText2) {
            blogText1.innerHTML = "10 збірок";
            blogText2.innerHTML = "Kingston DDR4 64GB";
        }
        if (blogText1 && blogText2) window.addEventListener("resize", (function() {
            if (window.innerWidth <= 479.98) {
                ...
                blogText1.innerHTML = "10 Кращих збірок 2023го року";
                blogText2.innerHTML = "Kingston DDR4 64GB  <br>Переглянемо її  <br>можливості";
            }
        }));
        ...
        function updateCopyrightText() {
            ...
            if (window.innerWidth <= 767.98) {
                if (copyrightElement) copyrightElement.innerHTML = `© «MELIO.UA», 2023 При копіюванні матеріалів із сайту посилання на джерело обов'язкове`;
            } else if (copyrightElement) copyrightElement.innerHTML = "© MELIO";
        }
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (readMoreButton && collapseButton && tabsBody && collapseWrapper) {
                readMoreButton.addEventListener("click", (function() {
                    tabsBody.innerHTML = `<h3 Склад збірки\n\n\t\t\t  </h3>\n\t\t\t  \n\t\t\t  <div class="info-product-card__text">\n\t\t\t  <b> Відеокарта </b><br>\n\t\t\t  <b>Продуктивність відеокарти</b>\n\t\t\t  12983\n\t\t\t  <br>\n\t\t\t  <b> Відеокарта</b>\n\t\t\t  RTX 3060<br>\n\t\t\t  <b>Обсяг відеопам'яті</b>\n\t\t\t  12 ГБ<br>\n\t\t\t  <b>Тип</b>\n\t\t\t  Дискретна<br>\n\t\t\t  <b>  Тип відеопам'яті</b>\n\t\t\t  GDDR6<br>\n\t\t\t  <b>Додатково</b>\n\t\t\t  Відновлена на заводі виробника (Factory Recertified)<br>\n\t\t\t  \n\t\t\t  <b> Материнська плата</b>\n\t\t\t  H410<br>\n\t\t\t  <b> Модель материнської плати</b>\n\t\t\t  Gigabyte H410<br>\n\t\t\t  <b> Оперативна пам'ять</b><br>\n\t\t\t  <b> Обсяг</b>\n\t\t\t  16 ГБ<br>\n\t\t\t  <b> Тип</b>\n\t\t\t  DDR4<br>\n\t\t\t  <b>Внутрішній накопичувач</b><br>\n\t\t\t  <b> Тип</b>\n\t\t\t  SSD<br>\n\t\t\t  <b> Обсяг SSD</b>\n\t\t\t  480 ГБ<br>\n\t\t\t  <b> Додатково</b><br>\n\t\t\t  Накопичувач SATA<br>\n\t\t\t  <b> Охолодження</b><br>\n\t\t\t  <b> Тип</b>\n\t\t\t  Повітряне<br>\n\t\t\t  <b> Додатково</b><br>\n\t\t\t  <b>  Потужність блоку живлення</b>\n\t\t\t  600 Вт<br>\n\t\t\t  <b> Оптичний привід</b>\n\t\t\t  Без оптичного приводу<br>\n\t\t\t  <b> Програмне забезпечення\n\t\t\t  Неактивована тестова версія Windows 11 Home</b><br>\n\t\t\t  <b> Колір</b>\n\t\t\t  Чорний\n\t\t\t  </div>`;
